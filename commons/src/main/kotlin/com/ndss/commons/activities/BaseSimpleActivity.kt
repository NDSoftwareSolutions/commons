package com.ndss.commons.activities
...
import com.ndss.commons.asynctasks.CopyMoveTask
import com.ndss.commons.dialogs.ConfirmationDialog
import com.ndss.commons.dialogs.ExportSettingsDialog
import com.ndss.commons.dialogs.FileConflictDialog
import com.ndss.commons.dialogs.WritePermissionDialog
import com.ndss.commons.extensions.*
import com.ndss.commons.helpers.*
import com.ndss.commons.interfaces.CopyMoveListener
import com.ndss.commons.models.FAQItem
import com.ndss.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.ndss")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.ndss.")
