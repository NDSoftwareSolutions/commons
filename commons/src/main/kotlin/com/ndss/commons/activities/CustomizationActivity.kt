...
import com.ndss.commons.dialogs.*
import com.ndss.commons.extensions.*
import com.ndss.commons.helpers.*
import com.ndss.commons.models.MyTheme
import com.ndss.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.ndss.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
