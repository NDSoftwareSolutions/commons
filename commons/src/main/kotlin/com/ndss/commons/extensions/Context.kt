...
import com.ndss.commons.R
import com.ndss.commons.helpers.*
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.ndss.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.ndss.commons.models.AlarmSound
import com.ndss.commons.models.BlockedNumber
import com.ndss.commons.models.SharedTheme
import com.ndss.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.ndss.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.ndss.thankyou")

fun Context.isAProApp() = packageName.startsWith("com.ndss.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.ndss."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.ndss.contacts") && !packageName.startsWith("com.ndss.dialer")) {
        true
    } else if ((packageName.startsWith("com.ndss.contacts") || packageName.startsWith("com.ndss.dialer")) && isQPlus()) {
